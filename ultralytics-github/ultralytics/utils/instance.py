...
class InstancesParsing:
    ...
    @classmethod
    def concatenate(cls, instances_list: List["InstancesParsing"], axis=0) -> "Instances":
        """
        Concatenates a list of Instances objects into a single Instances object.
        ...
        if not instances_list:
            return cls(np.empty(0))
        assert all(isinstance(instance, InstancesParsing) for instance in instances_list)
